                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header card-header-primary">
                            ...
                            <p class="card-category"> You Can Change Home Page Slider From Here </p>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            <a rel="tooltip" class="btn btn-success btn-link" href="{{route('edit.slider',[$row->id])}}" data-original-title="" title="">
                                                <i class="material-icons">edit</i>
                                                <div class="ripple-container"></div>
                                            </a>
                                            <a rel="tooltip" class="btn btn-success btn-link" onclick="return confirm('Are you sure you want to delete?')" href="{{route('delete.slider',[$row->id])}}" data-original-title="" title="">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{route('add.new.slider')}}" enctype="multipart/form-data">
                    @csrf
